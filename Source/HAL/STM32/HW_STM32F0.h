...
#ifdef CONFIG
#define CONFIG_INCLUDE < CONFIG.h >
...
#define EXTPLC_SIZEOF_RAM       512     // size in uint32_t
...
#define FEE_SIZE                0x4000                  // 16K
#define FEE_TRANSFER_PAGES      3                       // Reserved Pages for Transfer
